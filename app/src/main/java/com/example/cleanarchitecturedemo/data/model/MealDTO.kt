...
data class MealDTO(
 ...
 //function representing data for domain layer
// to convert MealDTO to Meal
fun MealDTO.toDomainMeal():Meal{
 ...
 //function to show data in detail on clicking image
// to convert MealDTO to MealDetails Model
